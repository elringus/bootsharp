...
public sealed class PublishBootsharp : Task
{
    [Required] public required string PublishDir { get; set; }
    [Required] public required string FrameworkDir { get; set; }
    [Required] public required string JSDir { get; set; }
    [Required] public required string WasmFile { get; set; }
