...
{
    /// <summary>
    /// Builds method endpoint string from specified assembly, namespace, class and method names.
    /// </summary>
    ...
    public static string BuildInvokable (string assembly, string @namespace, string @class, string method) => $"{assembly}/{@namespace}/{@class}/{method}";
