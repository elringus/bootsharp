...
public class TypesTest
{
    ...
    {
        Modules.Register(typeof(JSBackend), new ExportModule(typeof(IBackend), h => new JSBackend((IBackend)h)));
        Modules.Register(typeof(IFrontend), new ImportModule(new JSFrontend()));
    }
}
