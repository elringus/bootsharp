...
internal sealed record SerializedInstanceMeta (InstanceMeta Instance) : SerializedMeta(Instance.Clr);
...
internal sealed record SerializedPropertyMeta
{
    ...
    /// </summary>
    public required SerializedMeta Type { get; init; }
    /// <summary>
    ...
    /// </summary>
    public required bool Ctor { get; init; }
    /// <summary>
    ...
    /// </summary>
    public required string? FieldAccessor { get; init; }
}
