...
/// When applied to a static property makes it accessible in JavaScript.
/// When applied to a static event allows JavaScript consumers subscribe to it.
...
/// </code>
/// Expose "Counter" property to JavaScript:
/// <code>
/// [Export]
...
/// </code>
/// Expose "IService" interface and "Handler" class to JavaScript:
/// <code>
/// [assembly: Export(
///     typeof(IService),
///     typeof(Handler),
