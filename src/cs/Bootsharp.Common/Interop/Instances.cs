...
public static class Instances
{
    ...
    /// <summary>
    /// Invokes the specified factory to create and register an imported instance associated with the ID,
    /// unless an imported instance is already registered under the ID, in which case returns that instance.
    /// </summary>
