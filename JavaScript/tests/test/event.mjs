...
//         let result = 0;
//         const event = new EventSpec(null);
...
//         assert.deepStrictEqual(new EventSpec().getLast(), undefined);
//     });
