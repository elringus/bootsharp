...
**TL;DR** DotNetJS provides auto-generated interop layer between C# and JavaScript runtimes. Eg, below is all you need to get fully-typed interop between a language server written in C# and VS Code extension that runs in node and web browsers.
